...
export const ISOLanguages = [
    { code: 'all', name: 'All', nativeName: '全部' },
    { code: 'installed', name: 'Installed', nativeName: '已安装' },
    { code: 'updates pending', name: 'Updates pending', nativeName: '待更新' },

    { code: 'other', name: 'other langs?', nativeName: '其他' },

    { code: 'localsourcelang', name: '本地资源', nativeName: '本地资源' },
